...
import java.util.*;
/**
* this is the object that handles customer-to-substation-to-powerplant connections
*/
public class PSInputPoleConnection extends PSInputPole {
        Socket So;
        CustomerInputTransmissionLine lrt;

        public PSInputPoleConnection(CustomerInputTransmissionLine tlrt, Socket tso) {
                super();
                lrt = tlrt;
                So = tso;
        }
        ...
        public void Connect() {
           try {
                ...
                oos.flush();
                System.out.println("PSInputPoleConnection sent Customer Id "+getPowerSpace().toString());
                // see if OK
